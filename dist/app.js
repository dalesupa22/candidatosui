...
function beforeSendValidations() {
    ...
    if ($("input[name='politic_c']:checked").val() == null) errors.push("Por favor selecciona si apoyarias o no a un politico en la pregunta 4");
...
function consumeWebService(url, method, datos) {
